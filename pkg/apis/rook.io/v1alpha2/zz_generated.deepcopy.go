...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in StorageClassDeviceSets) DeepCopyInto(out *StorageClassDeviceSets) {
	{
		in := &in
		*out = make(StorageClassDeviceSets, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageClassDeviceSets.
func (in StorageClassDeviceSets) DeepCopy() StorageClassDeviceSets {
	if in == nil {
		return nil
	}
	out := new(StorageClassDeviceSets)
	in.DeepCopyInto(out)
	return *out
}
